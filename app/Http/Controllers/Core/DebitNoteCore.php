...
class DebitNoteCore
{
    ...
    public static function getFile($file)
    {
        ...
        $count = [];
        try {
            $count['DebitNote']['ext:UBLExtensions']['ext:UBLExtension']['ext:ExtensionContent']['sac:AdditionalInformation']
                ['sac:AdditionalMonetaryTotal'] = 0;
            $count['DebitNote']['ext:UBLExtensions']['ext:UBLExtension']['ext:ExtensionContent']['sac:AdditionalInformation']
                ['sac:AdditionalProperty'] = 0;
            $count ['DebitNote']['cac:TaxTotal'] = 0;
            $count['DebitNote']['cac:DebitNoteLine'] = 0;
            $a = 0;
            ...
            foreach ($file as $key => $value) {
                ...
                switch ($key) {
                    ...
                    case 0:
                        foreach ($line as $k => $v) {
                            switch ($k) {
                                /* Fecha de Emisión */
                                case 0:
                                    $response['DebitNote']['cbc:IssueDate'] = $v;
                                    break;
                                /* Firma Digital */
                                case 1:
                                    break;
                                ...
                                case 2:
                                    $response['DebitNote']['cac:AccountingSupplierParty']['cac:Party']['cac:PartyLegalEntity']
                                        ['cbc:RegistrationName'] = $v;
                                    break;
                                /* Nombre Comercial */
                                case 3:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['cac:AccountingSupplierParty']['cac:Party']
                                            ['cac:PartyName']['cbc:Name'] = $v;
                                    }
                                    break;
                                /* Domicilio Fiscal */ case 4:
                                    $explode = explode('!', $v);
                                    ...
                                    if (isset($explode[0]) && !empty($explode[0])) {
                                        foreach ($explode as $ke => $va) {
                                            switch ($ke) {
                                                /*  Numero de RUC */
                                                case 0:
                                                    $response['DebitNote']['cac:AccountingSupplierParty']
                                ...
                                case 6 :
                                    ...
                                    foreach ($explode as $ke => $va) {
                                        switch ($ke) {
                                            /* Serie y numero de documento afectado */
                                            case 0:
                                                $response['DebitNote']['cac:DiscrepancyResponse']
                                                    ['cbc:ReferenceID'] = $va;
                                                break;
                                            /* Tipo de documento - Catalogo No 06 */
                                            case 1:
                                ...
                                case 8 :
                                    ...
                                    foreach ($explode as $ke => $va) {
                                        switch ($ke) {
                                            /* Numero de documento */
                                            case 0:
                                                $response['DebitNote']['cac:AccountingCustomerParty']
                                                    ['cbc:CustomerAssignedAccountID'] = $va;
                                                break;
                                            /* Tipo de documento - Catalogo No 06 */
                                            case 1:
                                ...
                                case 9:
                                    $response['DebitNote']['cac:AccountingCustomerParty']['cac:Party']
                                        ['cac:PartyLegalEntity']['cbc:RegistrationName'] = $v;
                                    break;
                                /* Motivo o sustento */
                                case 10:
                                    $response['DebitNote']['cac:DiscrepancyResponse']['cbc:Description'] = $v;
                                    break;
                                    ...
                                    if (isset($explode[0]) && !empty($explode[0])) {
                                        foreach ($explode as $ke => $va) {
                                            switch ($ke) {
                                                ...
                                                case 0:
                                                    $response['DebitNote']['ext:UBLExtensions']['ext:UBLExtension']
                                                        ['ext:ExtensionContent']['sac:AdditionalInformation']
                                                        ['sac:AdditionalMonetaryTotal'][$count['DebitNote']['ext:UBLExtensions']
                                        ...
                                        $count['DebitNote']['ext:UBLExtensions']['ext:UBLExtension']['ext:ExtensionContent']
                                    ...
                                    if (isset($explode[0]) && !empty($explode[0])) {
                                        foreach ($explode as $ke => $va) {
                                            switch ($ke) {
                                                /* Sumatoria de IGV */
                                                case 0:
                                                    $response['DebitNote']['cac:TaxTotal'][$count['DebitNote']
                                ...
                                case 17:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['cac:RequestedMonetaryTotal']['cbc:ChargeTotalAmount'] = $v;
                                    }
                                    break;
                                /* Total descuentos */ case 18:
                                    $explode = explode('!', $v);
                                ...
                                /* Importe total */
                                case 19:
                                    $response['DebitNote']['cac:RequestedMonetaryTotal']['cbc:PayableAmount'] = $v;
                                    break;
                                /* Tipo de moneda en la cual se emite la nota de credito electronica */
                                case 20:
                                    $response['DebitNote']['cbc:DocumentCurrencyCode'] = $v;
                                    break;
                                /* Serie y numero del documento que modifica */
                                case 21:
                                    $response['DebitNote']['cac:BillingReference']['cac:InvoiceDocumentReference']
                                        ['cbc:ID'] = $v;
                                    break;
                                            ...
                                            if (isset($expl[0]) && !empty($expl[0])) {
                                                foreach ($expl as $k => $v) {
                                                    switch ($k) {
                                                        /* Numero de Guia */
                                                        case 0:
                                                            $response['DebitNote']['cac:DespatchDocumentReference'][$ke]
                                                                ['cbc:ID'] = $v;
                                                            break;
                                            ...
                                            if (isset($expl[0]) && !empty($expl[0])) {
                                                foreach ($expl as $k => $v) {
                                                    switch ($k) {
                                                        /* Numero de Guia */
                                                        case 0:
                                                            $response['DebitNote']['cac:AdditionalDocumentReference'][$ke]
                                                                ['cbc:ID'] = $v;
                                                            break;
                                ...
                                /* Version del UBL */
                                case 25:
                                    $response['DebitNote']['cbc:UBLVersionID'] = $v;
                                    break;
                                /* Version de la estructura del documento */
                                case 26:
                                    $response['DebitNote']['cbc:CustomizationID'] = $v;
                                    break;
                                # Datos extra-oficiales
                                /* Orden de Compra */
                                case 27:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['OrdenDeCompra'] = $v;
                                    }
                                    break;
                                /* Condiciones de Pago */
                                case 28:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['CondicionesDePago'] = $v;
                                    }
                                    break;
                                /* Fecha de Vencimiento */
                                case 29:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['FechaDeVencimiento'] = $v;
                                    }
                                    break;
                                /* Monto en Letras */
                                case 30:
                                                    ...
                                                    foreach ($expl as $k => $v) {
                                                        switch ($k) {
                                                            ...
                                                            case 0:
                                                                $response['DebitNote']['ext:UBLExtensions']['ext:UBLExtension']
                                                                    ['ext:ExtensionContent']['sac:AdditionalInformation']
                                                                    ['sac:AdditionalProperty'][$count['DebitNote']
                                ...
                                case 31:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['Observacion'] = $v;
                                    }
                                    break;
                                ...
                                case 33:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['ClienteCorreo'] = $v;
                                    }
                                    break;
                                /* Tipo de cambio */
                                case 34:
                                    $response['DebitNote']['ExtraOficial']['TipoDeCambio'] = $v;
                                    break;
                                ## LOLIMSA ##
                                case 35:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['c_value'] = $v;
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['c_name'] = 'cf';
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['n_index'] = $a;
                                        $a++;
                                    }
                                    break;
                                case 36:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['c_value'] = $v;
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['c_name'] = 'sec';
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['n_index'] = $a;
                                        $a++;
                                    }
                                    break;
                                case 37:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['c_value'] = $v;
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['c_name'] = 'usuario';
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['n_index'] = $a;
                                        $a++;
                                    }
                                    break;
                                case 38:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['c_value'] = $v;
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['c_name'] = 'correo_contacto';
                                        $response['DebitNote']['ExtraOficial']['Custom'][$a]['n_index'] = $a;
                                        $a++;
                                    }
                                    break;
                    ...
                    /* Detalle */
                    default:
                        $c['DebitNote']['cac:DebitNoteLine']['cac:PricingReference']['cac:AlternativeConditionPrice'] = 0;
                        $c['DebitNote']['cac:DebitNoteLine']['cac:TaxTotal'] = 0;
                        foreach ($line as $k => $v) {
                            switch ($k) {
                                /* Unidad de medida por item */
                                case 0:
                                    $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']['cac:DebitNoteLine']]
                                        ['cbc:DebitedQuantity']['@unitCode'] = $v;
                                    break;
                                /* Cantidad de unidades por item */
                                case 1:
                                    $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']['cac:DebitNoteLine']]
                                        ['cbc:DebitedQuantity']['amount'] = $v;
                                    break;
                                /* Codigo del producto */
                                case 2:
                                    if (isset($v) && !empty($v)) {
                                        $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']
                                            ['cac:DebitNoteLine']]['cac:Item']['cac:SellersItemIdentificacion']['cbc:ID'] = $v;
                                    }
                                    break;
                                ...
                                case 4:
                                    ...
                                    break;
                                /* Precio de venta unitario por item y codigo */ case 5 :
                                        ...
                                        switch ($ke) {
                                            ...
                                            case 0:
                                                $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']
                                                    ...
                                                    ['cac:AlternativeConditionPrice'][$c['DebitNote']['cac:DebitNoteLine']
                                    ...
                                    if (isset($explode[0]) && !empty($explode[0])) {
                                        foreach ($explode as $ke => $va) {
                                            switch ($ke) {
                                                ...
                                                case 0:
                                                    $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']
                                                        ['cac:DebitNoteLine']]['cac:TaxTotal'][$c['DebitNote']
                                                        ['cac:DebitNoteLine']['cac:TaxTotal']]['cbc:TaxAmount'] = $va;
                                                    break;
                                                /* Monto de IGV de la linea */
                                                case 1:
                                                    $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']
                                                        ['cac:DebitNoteLine']]['cac:TaxTotal'][$c['DebitNote']
                                                        ['cac:DebitNoteLine']['cac:TaxTotal']]['cac:TaxSubtotal']['cbc:TaxAmount'] = $va;
                                                    break;
                                                /* Afectacion al IGV - Catalogo No 07 */
                                                case 2:
                                                    $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']
                                                        ['cac:DebitNoteLine']]['cac:TaxTotal'][$c['DebitNote']
                                                        ['cac:DebitNoteLine']['cac:TaxTotal']]['cac:TaxSubtotal']
                                        ...
                                        $c['DebitNote']['cac:DebitNoteLine']['cac:TaxTotal'] ++;
                                    }
                                ...
                                case 8:
                                    $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']
                                        ['cac:DebitNoteLine']]['cbc:LineExtensionAmount'] = $v;
                                    break;
                                /* Numero de orden del item */
                                case 9:
                                    $response['DebitNote']['cac:DebitNoteLine'][$count['DebitNote']
                                        ['cac:DebitNoteLine']]['cbc:ID'] = $v;
                                    break;
                            }
                        }
                        $count['DebitNote']['cac:DebitNoteLine'] ++;
                        break;
                }
            }
            $output['status'] = true;
            ...
            Log::info('Generación de array',
                [
                'lgph_id' => 1, 'c_id' => $response['DebitNote']['cbc:ID'],
                'c_invoice_type_code' => '08',
                ]
            );
        } catch (Exception $exc) {
    ...
    public static function validateFile($array)
    {
        ...
        $validation = array(
            'DebitNote.cbc:UBLVersionID' => 'required|max:10',
            'DebitNote.cbc:CustomizationID' => 'required|max:10',
            'DebitNote.cbc:ID' => 'required|max:13',
            'DebitNote.cbc:IssueDate' => 'required|max:10',
            'DebitNote.cbc:DocumentCurrencyCode' => 'required|size:3',
        );
        $messages = array(
            'DebitNote.cbc:UBLVersionID.required' => 'La version del UBL es requerido.',
            'DebitNote.cbc:UBLVersionID.max' => 'La version del UBL excedió la cantidad de caracteres.',
            'DebitNote.cbc:CustomizationID.required' => 'La versión de la estructura del Documento es requerido.',
            'DebitNote.cbc:CustomizationID.max' => 'La versión de la estructura del Documento excedió la cantidad de caracteres.',
            'DebitNote.cbc:ID.required' => 'La serie y el numero correlativo es requerido.',
            'DebitNote.cbc:ID.max' => 'La serie y el numero correlativo excedió la cantidad de caracteres.',
            'DebitNote.cbc:IssueDate.required' => 'La Fecha de emisión es requerido.',
            'DebitNote.cbc:IssueDate.max' => 'La Fecha de emisión excedió la cantidad de caracteres.',
            'DebitNote.cbc:DocumentCurrencyCode.required' => 'El tipo de moneda es requerido.',
            'DebitNote.cbc:DocumentCurrencyCode.size' => 'El tipo de moneda no tiene 3 caracteres.',
        );
        $validator = Validator::make($array, $validation, $messages);
        if ($validator->fails()) {
            Log::error('Error en cabecera: ' . implode(',', $validator->messages()->all()),
                ['lgph_id' => 2, 'c_id' => $array['DebitNote']['cbc:ID'], 'c_invoice_type_code' => '08',]);
            throw new Exception(implode(',', $validator->messages()->all()));
        }

        if (isset($array['DebitNote']['ext:UBLExtensions']['ext:UBLExtension']['ext:ExtensionContent']
                ['sac:AdditionalInformation']['sac:AdditionalMonetaryTotal'])) {
            foreach ($array['DebitNote']['ext:UBLExtensions']['ext:UBLExtension']['ext:ExtensionContent']
        ...
        if (isset($array['DebitNote']['cac:DespatchDocumentReference']) &&
            !empty($array['DebitNote']['cac:DespatchDocumentReference'])) {
            $i = 1;
            foreach ($array['DebitNote']['cac:DespatchDocumentReference'] as $key => $value) {
                $validation = array(
        ...
        if (isset($array['DebitNote']['cac:AdditionalDocumentReference']) &&
            !empty($array['DebitNote']['cac:AdditionalDocumentReference'])) {
            $i = 1;
            foreach ($array['DebitNote']['cac:AdditionalDocumentReference'] as $key => $value) {
                $validation = array(
                    'cbc:ID' => 'required|max:30',
                    'cbc:DocumentTypeCode' => 'required|size:2',
                );
        ...
        $validation = array(
            'DebitNote.cac:AccountingSupplierParty.cbc:CustomerAssignedAccountID' => 'required|size:11',
            'DebitNote.cac:AccountingSupplierParty.cbc:AdditionalAccountID' => 'required|size:1',
        );
        $messages = array(
            'DebitNote.cac:AccountingSupplierParty.cbc:CustomerAssignedAccountID.required' => 'El número de documento de identidad (RUC) es requerido.',
            'DebitNote.cac:AccountingSupplierParty.cbc:CustomerAssignedAccountID.size' => 'El número de documento de identidad (RUC) no tiene 11 caracteres.',
            'DebitNote.cac:AccountingSupplierParty.cbc:AdditionalAccountID.required' => 'El tipo de documento de identificación es requerido.',
            'DebitNote.cac:AccountingSupplierParty.cbc:AdditionalAccountID.size' => 'El tipo de documento de identificación no tiene 2 caracter.',
        );
        $validator = Validator::make($array, $validation, $messages);
        if ($validator->fails()) {
            Log::error('Error en cabecera: ' . implode(',', $validator->messages()->all()),
        ...
        if (isset($array['DebitNote']['cac:AccountingSupplierParty']['cac:Party'])) {
            if (isset($array['DebitNote']['cac:AccountingSupplierParty']['cac:Party']['cac:PartyName'])) {
                $validation = array(
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PartyName.cbc:Name' => 'required|max:100',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PartyLegalEntity.cbc:RegistrationName' => 'required|max:100',
                );
                $messages = array(
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PartyName.cbc:Name.required' => 'Nombre comercial es requerido.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PartyName.cbc:Name.max' => 'Nombre comercial no puede exceder 100 caracteres',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PartyLegalEntity.cbc:RegistrationName.required' => 'Apellidos y nombres o denominación o razón social es requerido.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PartyLegalEntity.cbc:RegistrationName.max' => 'Apellidos y nombres o denominación o razón social no puede exceder 100 caracteres',);
                $validator = Validator::make($array, $validation, $messages);
                if ($validator->fails()) {
                    Log::error('Error en cabecera: ' . implode(',', $validator->messages()->all()),
                        ['lgph_id' => 2, 'c_id' => $array['DebitNote']['cbc:ID'], 'c_invoice_type_code' => '08',]);
            ...
            if (isset($array['DebitNote']['cac:AccountingSupplierParty']['cac:Party']['cac:PostalAddress'])) {
                $validation = array(
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:ID' => 'size:6',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:StreetName' => 'required|max:100',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:CitySubdivisionName' => 'max:25',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:CityName' => 'max:30',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:CountrySubentity' => 'max:30',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:District' => 'max:30',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cac:Country.cbc:IdentificationCode' => 'size:2',
                );
                $messages = array(
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:ID.size' => 'El código de UBIGEO no tiene 6 caracteres.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:StreetName.required' => 'La dirección completa y detallada es requerida.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:StreetName.max' => 'La dirección completa y detallada excedió los 100 caracteres.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:CitySubdivisionName.max' => 'La ubicación o zona excedió los 25 caracteres.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:CityName.max' => 'El departamento excedió los 30 caracteres.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:CountrySubentity.max' => 'La provincia excedió los 30 caracteres.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cbc:District.max' => 'El distrito excedió los 30 caracteres.',
                    'DebitNote.cac:AccountingSupplierParty.cac:Party.cac:PostalAddress.cac:Country.cbc:IdentificationCode.size' => 'El código del pais no tiene 2 caracteres.',
                );
                $validator = Validator::make($array, $validation, $messages);
                if ($validator->fails()) {
                    Log::error('Error en cabecera: ' . implode(',', $validator->messages()->all()),
        ...
        $validation = array(
            'DebitNote.cac:AccountingCustomerParty.cbc:CustomerAssignedAccountID' => 'required|max:15',
            'DebitNote.cac:AccountingCustomerParty.cbc:AdditionalAccountID' => 'required|size:1',
            'DebitNote.cac:AccountingCustomerParty.cac:Party.cac:PartyLegalEntity.cbc:RegistrationName' => 'required|max:100',
        );
        $messages = array(
            'DebitNote.cac:AccountingCustomerParty.cbc:CustomerAssignedAccountID.required' => 'El número de documento de identidad es requerido.',
            'DebitNote.cac:AccountingCustomerParty.cbc:CustomerAssignedAccountID.max' => 'El número de documento de identidad excedió los 15 caracteres.',
            'DebitNote.cac:AccountingCustomerParty.cbc:AdditionalAccountID.required' => 'Tipo de documento de identificación es requerido.',
            'DebitNote.cac:AccountingCustomerParty.cbc:AdditionalAccountID.size' => 'Tipo de documento de identificación no tiene 1 caracter.',
            'DebitNote.cac:AccountingCustomerParty.cac:Party.cac:PartyLegalEntity.cbc:RegistrationName.required' => 'Apellidos y nombres o denominación o razón social según RUC es requerido.',
            'DebitNote.cac:AccountingCustomerParty.cac:Party.cac:PartyLegalEntity.cbc:RegistrationName.max' => 'Apellidos y nombres o denominación o razón social según RUC excedió los 100 caracteres.',);
        $validator = Validator::make($array, $validation, $messages);
        if ($validator->fails()) {
            Log::error('Error en cabecera: ' . implode(',', $validator->messages()->all()),
                ['lgph_id' => 2, 'c_id' => $array['DebitNote']['cbc:ID'], 'c_invoice_type_code' => '08',]);
        ...
        if (isset($array['DebitNote']['cac:TaxTotal'])) {
            foreach ($array['DebitNote']['cac:TaxTotal'] as $value) {
                $validation = array(
        ...
        $validation = array(
            'DebitNote.cac:RequestedMonetaryTotal.cbc:ChargeTotalAmount' => 'max:15',
            'DebitNote.cac:RequestedMonetaryTotal.cbc:PayableAmount' => 'required|max:15',
        );
        $messages = array(
            'DebitNote.cac:RequestedMonetaryTotal.cbc:ChargeTotalAmount.max' => 'Importe total de cargos aplicados al total de la factura excedió los 15 caracteres.',
            'DebitNote.cac:RequestedMonetaryTotal.cbc:PayableAmount.required' => 'Moneda e Importe total a pagar es requerido.',
            'DebitNote.cac:RequestedMonetaryTotal.cbc:PayableAmount.max' => 'Moneda e Importe total a pagar excedió los 15 caracteres.',
        );
        $validator = Validator::make($array, $validation, $messages);
        if ($validator->fails()) {
            Log::error('Error en cabecera: ' . implode(',', $validator->messages()->all()),
        ...
        foreach ($array['DebitNote']['cac:DebitNoteLine'] as $key => $value) {
            $itemIndex = $key + 1;
            $validation = array(
                'cbc:ID' => 'required|max:3',
                'cbc:DebitedQuantity.amount' => 'required|max:16',
                'cbc:DebitedQuantity.@unitCode' => 'required|max:3',
            ...
            $messages = array(
                ...
                'cbc:DebitedQuantity.@unitCode.required' => 'Unidad de medida por Ítem (UN/ECE rec 20) es requerido.',
                'cbc:DebitedQuantity.@unitCode.max' => 'Unidad de medida por Ítem (UN/ECE rec 20) excedió los 3 caracteres.',
                'cbc:DebitedQuantity.amount.required' => 'Cantidad de unidades por Ítem es requerido.',
                'cbc:DebitedQuantity.amount.max' => 'Cantidad de unidades por Ítem excedió los 3 caracteres.',
            ...
            if ($validator->fails()) {
                Log::error("Error en detalle, Ítem #{$itemIndex}: " . implode(',', $validator->messages()->all()),
                    ['lgph_id' => 2, 'c_id' => $array['DebitNote']['cbc:ID'], 'c_invoice_type_code' => '08', 'c_item_sellers_item_identification_id' => $value['cac:Item']['cac:SellersItemIdentification']['cbc:ID']]);
                throw new Exception(implode(',', $validator->messages()->all()));
            }
        ...
        Log::info('Validación de array',
            [
            'lgph_id' => 2, 'c_id' => $array['DebitNote']['cbc:ID'],
            'c_invoice_type_code' => '08',
            ]
        );
    }
    ...
    public static function setDb($array)
    {
        ...
        try {
            $supSupplierArray = $array['DebitNote']['cac:AccountingSupplierParty'];
            ...
            # CLIENTE
            $cusCustomerArray = $array['DebitNote']['cac:AccountingCustomerParty'];
            ...
            # Documento
            $docInvoiceArray = $array['DebitNote'];
            $docInvoice = DocInvoice::where('c_id', $docInvoiceArray['cbc:ID'])->where('n_id_supplier', $supSupplierId)
                    ->where('c_invoice_type_code', '08')->whereIn('c_status_invoice', array('visible', 'hidden'));
            if ($docInvoice->count()) {
            ...
            $docInvoice->c_invoice_type_code = '08';
            ...
            $related = DocInvoice::where('c_id', $array['DebitNote']['cac:DiscrepancyResponse']['cbc:ReferenceID'])->where('c_status_invoice',
                    'visible')
                ->whereIn('c_invoice_type_code', array('03', '01'));
            if ($related->count() == 0) {
                throw new Exception('No existe la boleta/factura: ' . $array['DebitNote']['cac:DiscrepancyResponse']['cbc:ReferenceID']);
            }
            if ($related->count() > 1) {
                throw new Exception('Error de sistema, existe más de un(a) boleta/factura activa: ' . $array['DebitNote']['cac:DiscrepancyResponse']['cbc:ReferenceID']);
            }
            ...
            $docInvoiceDiscrepancyResponse->c_reference_id = $array['DebitNote']['cac:DiscrepancyResponse']['cbc:ReferenceID'];
            $docInvoiceDiscrepancyResponse->c_response_code = $array['DebitNote']['cac:DiscrepancyResponse']['cbc:ResponseCode'];
            $docInvoiceDiscrepancyResponse->c_description = $array['DebitNote']['cac:DiscrepancyResponse']['cbc:Description'];
            $docInvoiceDiscrepancyResponse->save();

            if (isset($docInvoiceArray['ext:UBLExtensions']['ext:UBLExtension'] ['ext:ExtensionContent']
                    ['sac:AdditionalInformation']['sac:AdditionalMonetaryTotal']) && !empty($docInvoiceArray
                    ['ext:UBLExtensions']['ext:UBLExtension']['ext:ExtensionContent']['sac:AdditionalInformation']['sac:AdditionalMonetaryTotal'])) {
            ...
            if (isset($array['DebitNote']['cac:TaxTotal'])) {
                ...
                $docInvoiceTaxTotalArray = $array['DebitNote']['cac:TaxTotal'];
            ...
            $docInvoiceLegalMonetaryTotalArray = $docInvoiceArray['cac:RequestedMonetaryTotal'];
            ...
            $docInvoiceBillingReferenceInvoiceDocumentReference->c_id = $array['DebitNote']['cac:BillingReference']
                ['cac:InvoiceDocumentReference']['cbc:ID'];
            $docInvoiceBillingReferenceInvoiceDocumentReference->c_document_type_code = (isset($array['DebitNote']
                    ['cac:BillingReference']['cac:InvoiceDocumentReference']['cbc:DocumentTypeCode'])) ? $array['DebitNote']
            ...
            # ITEM
            $docInvoiceItemArray = $docInvoiceArray['cac:DebitNoteLine'];

            foreach ($docInvoiceItemArray as $key => $value) {
                $docInvoiceItem = new DocInvoiceItem();
                $docInvoiceItem->n_id_invoice = $docInvoiceId;
                if (isset($value['cbc:DebitedQuantity']['@unitCode']) &&
                    !empty($value['cbc:DebitedQuantity']['@unitCode'])) {
                    $docInvoiceItem->c_invoiced_quantity_unit_code = $value ['cbc:DebitedQuantity']['@unitCode'];
                }
                if (isset($value['cbc:DebitedQuantity']['amount']) && !empty($value['cbc:DebitedQuantity']['amount'])) {
                    $docInvoiceItem->c_invoiced_quantity = $value['cbc:DebitedQuantity'] ['amount'];
                }
                ...
                if (isset($value['cac:PricingReference']['cac:AlternativeConditionPrice']['cbc:PriceAmount']) &&
                    !empty($value['cac:PricingReference']['cac:AlternativeConditionPrice']['cbc:PriceAmount'])) {
            ...
            Log::info('Grabado en BD',
                [
                'lgph_id' => 3, 'c_id' => $array['DebitNote']['cbc:ID'], 'c_invoice_type_code' => '08',
     ...
     * @return array
     */
    public static function buildXml($debitNoteId)
    {
        $response['status'] = 0;
        $response['message'] = '';
        $response['path'] = '';
        ...
        try {
            $docInvoiceData = DocInvoice::find($debitNoteId);

            if (is_null($docInvoiceData)) {
            ...
            if ($docInvoiceDespatchDocumentReference->count()) {
                foreach ($docInvoiceDespatchDocumentReference as $key => $value) {
                    ...
                    $debitNote->appendChild($despatchDocumentReference);
                    $id = $dom->createElement('cbc:ID');
                    $id->nodeValue = $value->c_id;
                    $documentTypeCode = $dom->createElement('cbc:DocumentTypeCode');
            ...
            if ($docInvoiceAdditionalDocumentReference) {
                foreach ($docInvoiceAdditionalDocumentReference as $key => $value) {
                    ...
                    $debitNote->appendChild($additionalDocumentReference);
            ...
            $debitNote->appendChild($accountingSupplierParty);
            ...
            $debitNote->appendChild($accountingCustomerParty);
            $customerAssignedAccountId = $dom->createElement('cbc:CustomerAssignedAccountID');
            ...
            if ($docInvoiceTaxTotalData->count()) {
            ...
            foreach ($docInvoiceItemData as $key => $value) {
                $invoiceLine = $dom->createElement('cac:DebitNoteLine');
                $debitNote->appendChild($invoiceLine);
                ...
                if (isset($value->c_invoiced_quantity) && !empty($value->c_invoiced_quantity)) {
                    ...
                    $debitedQuantity->nodeValue = $value->c_invoiced_quantity;
                    ...
                    $invoiceLine->appendChild($debitedQuantity);
                }
                ...
                if ($docInvoiceItemTaxTotalData->count()) {
                    foreach ($docInvoiceItemTaxTotalData as $k => $v) {
                        ...
                        $docInvoiceItemTaxTotalTaxSubtotal = $v
                            ->docInvoiceItemTaxTotalTaxSubtotal;
            ...
            $xmlName = sprintf('%s-%s-%s', $docInvoiceSupplier->c_customer_assigned_account_id, '08',
                $docInvoiceData->c_id);
            ...
            if (env('XMLDSIG')) {
                ...
                if (isset($ds) && !empty($ds)) {
                    ...
                    $docInvoiceSignature->n_id_invoice = $debitNoteId;
            ...
            $docInvoiceFile->n_id_invoice = $debitNoteId;
            ...
            Log::info('Generación de XML',
                [
                'lgph_id' => 4, 'n_id_invoice' => $debitNoteId, 'c_invoice_type_code' => '08'
                ]
            );
        } catch (Exception $exc) {
            Log::error($exc->getMessage(),
